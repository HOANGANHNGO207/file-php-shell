...
if (isset($_GET['i'])) {
    ...
    $pngs = [
        // 1×1 transparent
        'iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNk+A8AAZMBgFCBdLIAAAAASUVORK5CYII=',
        // 2×2 transparent
        'iVBORw0KGgoAAAANSUhEUgAAAAIAAAACCAYAAABytg0kAAAAFUlEQVR42mP8z/CfAQADfgH+fM56YgAAAABJRU5ErkJggg==',
        // Emoji-style PNG
        '',
        // Pixel pattern
        ''
    ];

    $key = isset($_GET['i']) && is_numeric($_GET['i']) && isset($pngs[$_GET['i']]) ? $_GET['i'] : array_rand($pngs);
    echo base64_decode($pngs[$key]);
    exit;
}
